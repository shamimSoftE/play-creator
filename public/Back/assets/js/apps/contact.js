$(document).ready(function() {
  ...
  $('#input-search').on('keyup', function() {
    var rex = new RegExp($(this).val(), 'i');
      $('.searchable-items .items:not(.items-header-category)').hide();
      $('.searchable-items .items:not(.items-header-category)').filter(function() {
...
function addContact() {
  $("#btn-add").click(function() {
    ...
    $html = '<div class="items">' +
      ...
      $(".searchable-items > .items-header-category").after($html);
